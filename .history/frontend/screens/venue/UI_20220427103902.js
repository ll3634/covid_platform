								...
								<View style={[styles.cardText]}>
									...
									<View style={styles.detailWrapper}>
										<View style={styles.detail}>
											<Text style={styles.info}> # OF VISIT: {props.checkin[item.id - 1].check_num ? props.checkin[item.id - 1].check_num : 0} </Text>
										</View>
										<View style={styles.detail}>
											<Text style={styles.info}> # OF CASES: {props.checkin[item.id - 1].case_num ? props.checkin[item.id - 1].case_num : 0} </Text>
										</View>
									</View>
								</View>
							</View>
