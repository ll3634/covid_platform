...
Rule = (props) => {
    ...
    props.setAddCapacities(props.start, props.end)
	}
	...
	return (
      ...
      <View style={{marginTop: 25, marginLeft: 10}}><Text>Current Seats</Text><Text>{props.capacity}</Text></View>

          <View style = {{positon: 'absolute', top:'70%'}}>
			<Button
