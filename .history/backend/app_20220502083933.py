...
@app.route('/addcapacity/<int:capacity>/<int:capacity>')
def addcapacity(capacity, interval):
  def job2():
    with app.app_context():
      period.Job2(int(capacity))
  scheduler.add_job(func=job2, id='do_job_2', trigger='interval', seconds=int(interval))
  return "Succeed, Calling Task!"
