...
import { getSetPasswordAction, getSetPhoneAction, getSetSMSAction, sendSMS, codeLoginAction, getSetVefifyAction } from './actionCreator'
...
const mapDispatch = (dispatch) => {
	return {
		...
		setVerify(res) {
			...
			dispatch(action)
			const action2 = getSetTokenAction(res)
		}
	}
}
