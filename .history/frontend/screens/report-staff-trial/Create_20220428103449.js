...
Create = (props) => {
	...
	return (
		...
		>
			...
			{/* <View style={{ flexDirection: 'row', marginVertical: 0, marginHorizontal: 0, }}> */}
			<View style={{ flexDirection: 'row', marginTop: 50, marginHorizontal: 10, justifyContent: 'space-between', alignItems: 'center' }}>
				<Text style={{fontStyle: 'italic'}}>Longitude: {props.longitude}</Text>
				<Text style={{fontStyle: 'italic'}}>Latitude: {props.latitude}</Text>
			</View>
			<View style={[styles.badge, { height: 75,  padding: 0, zIndex:1 }]}>
					<MapView
			...
			<View style={{ flexDirection: 'row', marginVertical: 0, marginHorizontal: 10, }}>
				...
				<TextInput
					...
					style={[styles.searchBox3, { height: 35, width: 230.5 }]}
				/>
			</View>
			...
			<View style={{backgroundColor: 'white', marginVertical: 5, borderRadius: 0, height: 39, alignSelf: 'center', width:'49.75%',shadowColor: '#ccc',
		...
		elevation: 10}}>
			...
			<View style={{backgroundColor: 'white', marginVertical: 5, borderRadius: 0, width:'59.5%', shadowColor: '#ccc',
		shadowOffset: { width: 0, height: 3 },
		shadowOpacity: 0.5,
		shadowRadius: 5,
		elevation: 10}}>
			...
			<View style={{backgroundColor: 'white', marginVertical: 5, borderRadius: 0, width: '77.5%',shadowColor: '#ccc',
		shadowOffset: { width: 0, height: 3 },
		shadowOpacity: 0.5,
		shadowRadius: 5,
		elevation: 10}}>
...
const createVenue = (name, description, lat, lng, num, capacity, start, end) => async (dispatch) => {
...
const mapDispatch = (dispatch) => {
	return {
		createVenues(name, description, lat, lng, num, capacity, start, end) {
			dispatch(createVenue(name, description, lat, lng, num, capacity, start, end))
		},
		setName(res) {
			if (res) {
